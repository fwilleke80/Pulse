...
class CompleteConfigurationPersistenceTest extends TestCase
{
	...
	private function CreateFixture(): void
	{
		...
		$this->_connection->exec('CREATE TABLE contacts (id BIGINT UNSIGNED PRIMARY KEY, user_id BIGINT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, email_checked_at DATETIME NULL, email_2 VARCHAR(255) NULL, email_2_checked_at DATETIME NULL, email_3 VARCHAR(255) NULL, email_3_checked_at DATETIME NULL, email_4 VARCHAR(255) NULL, email_4_checked_at DATETIME NULL, cell_phone VARCHAR(50) NULL, notes TEXT NULL) ENGINE=InnoDB');
